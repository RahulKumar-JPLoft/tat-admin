  ...
  return (
    <Fragment>
      <>
        ...
        <p>
          <b>Terms & Privicy Policy</b>
        </p>
        <p>
          Please read this End-User License Agreement carefully before clicking
          the &quot;I Agree&quot; button, downloading or using Tradie .
        </p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              by the Company downloaded by You to a Device, named Tradie
            </p>
          </li>
          <li>
            <p>
              ...
              in this Agreement) refers to Tap A Tradie Pty Ltd, Australia .
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>Email : tapatradie@gmail.com</li>
        </ul>
      </>
    </Fragment>
  );
